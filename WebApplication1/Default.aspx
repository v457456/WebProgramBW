                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RegularExpressionValidator runat="server" display="Dynamic"
                                                ...
                                                validationexpression="[a-zA-Z0-9_.\-\@]{3,15}" ValidationGroup="Login1">Username must be 3-15 characters (Specials allowed: @,_,.,-).</asp:RegularExpressionValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            ...
                                            <asp:RegularExpressionValidator runat="server" display="Dynamic"
                                                ...
                                                validationexpression="[A-Za-z0-9_.\-\!\@\#\$\%\&\*]{5,25}" ValidationGroup="Login1">Password must be 5-25 characters (Specials allowed: !,@,#,$,%,&,_,-,.,*).</asp:RegularExpressionValidator>
                                        </td>
                                    </tr>
