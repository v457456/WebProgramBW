...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
        ...
        <table style="width: 538px; height: 132px; color: #000000;margin: 0 auto 0 auto;" 
            ...
            <tr>
                ...
                <td align="left" class="style5" >
                    <input id="Text1" type="text" name="in_firstname"/></td>
            </tr>
            <tr>
                <td align="right" class="style2">
                    Last Name:</td>
                <td align="left" class="style5">
                    <input id="Text2" type="text" name="in_lastname" /></td>
            </tr>
            <tr>
                <td align="right" class="style2">
                    Email Address:</td>
                <td align="left" class="style5">
                    <input id="Text3" type="text" name="in_email"/></td>
            </tr>
            <tr>
                <td align="right" class="style2">
                    Experience Level:</td>
            ...
            <tr>
                ...
                <td align="left" class="style5">
                    ...
                    <input id="Text5" type="text" maxlength="3" value="40" name="in_workhours"/></td>
            </tr>
            <tr>
                <td align="right" class="style2">
                    Industry:</td>
    ...
    <asp:Label ID="outputLabel" runat="server" Text="Information Entered Incorrectly" 
        ...
        <div style="margin:0 auto 0 auto; width:750px">
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PageSize="25" GridLines="None" BackColor="#B3C0C4" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Experience Level" HeaderText="Experience" 
        ...
        <asp:SqlDataSource ID="SqlDataProjectsResources" runat="server" 
            ConnectionString="<%$ ConnectionStrings: group3local %>" 
